    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(default='2020-02-06 16:50:15+00:00')),
                ('created_at', models.DateTimeField(default='2020-02-06 16:50:15+00:00')),
                ('published', models.BooleanField(default=False)),
                ('hub_member', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('master_document', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='gallery.SharedDocument')),
                ('spaces', models.ManyToManyField(blank=True, related_name='spaces', to='gallery.HubSpace')),
            ],
        ),
        migrations.CreateModel(
            name='DocumentLike',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_at', models.DateTimeField(default='2020-02-13 16:50:15+00:00')),
                ('document', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='gallery.SharedDocument')),
                ('hub_member', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
